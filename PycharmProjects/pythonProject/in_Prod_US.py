...
print(driver.title)
# driver.find_element(by=By.ID,value="ctx-accordion-group-header-0").click()
# driver.find_element(by=By.ID,value="daasDashboardImageBuild").click()
# driver.find_element(by=By.ID,value='username').send_keys('hao.zhang@citrix.com')
# # 登录输入密码
# driver.find_element(by=By.ID,value='username').send_keys('xinxia.si@citrix.com')
# driver.find_element(by=By.ID,value='password').send_keys('Best234@#$')
# driver.find_element(by=By.ID,value="submit").click()

# # 选择customer登录
# driver.find_element('xpath','/html/body/div[2]/div/div/div/section/div/section[2]/div/div/div/section/input').send_keys('mtprod7')
...
# driver.find_element('xpath','/html/body/div/div/div/div/section/div/section[2]/div/div/div/section/input').send_keys('dil1xdeprod')
...
# #选择customer登录
# driver.find_element('xpath','/html/body/div/div/div/div/section/div/section[2]/div/div/div/section/input').click()
# driver.find_element('xpath','/html/body/div/div/div/div/section/div/section[2]/div/div/div/section/input').send_keys('prodtest1az')
# driver.find_element('xpath','/html/body/div/div/div/div/section/div/section[2]/div/div/div/ol/li/h2').click()
# time.sleep(20)
# driver.find_element('xpath','//*[@id="ctx-navbar"]/div[1]/div[1]/ctx-icon[1]/div/div').click()
# time.sleep(2)
